...
class _DonorHomePageState extends State<DonorHomePage> {
  ...
  Future<void> _loadHomeData() async {
    try {
      ...
      final beneficiariesFuture =
          FirebaseFirestore.instance.collection('beneficiaries').get();
      ...
      final donationsSnapshot = results[1] as QuerySnapshot<Map<String, dynamic>>;
      ...
      for (final doc in donationsSnapshot.docs) {
        ...
        final donorId = (data['donorID'] ?? '').toString().trim();
      ...
      setState(() {
        ...
        clothingCount = totalCompletedItems;
